...
public class MagyarNemetInsert extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magyar_nemet_insert);
    ...
    public void onClick(View v) {
        if (v == Felvitel) {
            if (SzoEditText.getText().toString().length() != 0) {
                ...
                Intent eredeti = new Intent(MagyarNemetInsert.this, MagyarNemetInsert.class);
